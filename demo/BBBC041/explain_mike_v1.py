# -*- coding: utf-8 -*-
"""
Created on Wed Nov  9 00:34:46 2022
...
ref = Generator(config['netG'], True, [0, 1, 2])
ref.load_state_dict(torch.load("gen_00430000.pt",map_location=torch.device('cpu')))
